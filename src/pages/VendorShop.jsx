...
const VendorShopPage = () => {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment:
        "Absolutely stunning craftsmanship! The attention to detail is incredible and it arrived perfectly packaged. Will definitely order again!",
      date: "2 weeks ago",
      verified: true,
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Great quality and beautiful design. Shipping was fast and communication was excellent throughout the process.",
      date: "1 month ago",
      verified: true,
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "These handmade pieces are truly works of art. The colors and textures are even more beautiful in person!",
      date: "3 weeks ago",
      verified: true,
  ...
  return (
    <div className="min-h-screen bg-[#">
      {/* Hero Header Section */}
      <div className="relative bg-[#4b6382] overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left text-white">
              ...
              <p className="text-blue-100 mb-4 text-sm sm:text-base lg:text-lg max-w-2xl">
                {vendor.bio}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <button className="flex items-center justify-center px-6 py-3 bg-transparent border-2 border-white/50 text-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                  <MessageCircle className="w-5 h-5 mr-2" />
                  <a href="#contact"></a>
                  Message
                </button>
                <button className="flex items-center justify-center px-6 py-3 bg-green-500 text-white rounded-full font-semibold hover:bg-green-600 transition-all duration-300 transform hover:scale-105 shadow-xl">
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Have questions about our products or want to discuss a custom
